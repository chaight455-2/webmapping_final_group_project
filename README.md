...
1. Persona/Scenario
    1. Persona:
Our user persona is a hypotheical UW-Madison student named Bob. Bob is a freshman that just started at UW Madison and is settling into living on a new campus. Bob has only been living in the dorms for a week now, so he doesn't know where many of the campus buildings are and what utilities are inside of them. Bob has found this especially difficult since he only has a limited amount of time between his classes and would like to be able to access certain utilities (such as a microwave or bathroom) before his next class. While Bob knows where his classes are and is gaining a better idea of how campus is structured, he hasn't been exposed to where many of campus utitlies are. Some examples of these utilies are campus study spaces, refrigerators, microwaves, vending machines, and individual/gender neutral bathrooms.
    2. Scenario:
